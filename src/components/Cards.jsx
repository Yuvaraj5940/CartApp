            ...
            <View style={styles.cards}>
              <View style={styles.card_img}>
                  <ImageBackground 
                      ...
                      source={{uri: `${item.img}`}} style={{resizeMode:'cover', width:'100%', height:'100%'}} 
                    >
                    <Pressable>
                        <Image
                    ...
                    <View style={{position:'relative', top:70}}>
                      <Text style={styles.omimgText1}>{item.offer_h !=='undefined'? item.offer_h: null}</Text>
                      <Text style={styles.omimgText2}>{item.offer_d !=='undefined'? item.offer_d: null }</Text>
                    </View>
              ...
              <View style={styles.card_col2}>
                ...
                <View style={styles.card_col2_row2}>
                  ...
                  <Text style={styles.h3}>
                    {item.rating}{extract(item.noOfvote)}  &bull; {item.delivary_Time}min
                  </Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  omimgText1:{fontSize:22, fontWeight:'bold',color:'#ffff',elevation:5,paddingLeft:10},
  omimgText2:{fontSize:17, fontWeight:'bold',color:'#ffff', paddingLeft:10},
  simg2:{
    width:20,
    height:20,
    position:'relative',
  ...
  lastrow:{display:'flex',flexDirection:'row',alignItems:'center',gap:5, marginHorizontal:10, marginTop:10},
