...
const Profile = ({navigation}) => {
  ...
  const List = [
    {title: 'My Account', info: 'Favourits, Hidden restorents & Settings'},
    {title: 'App Money', info: 'View Account Balance & Transactions History'},
    {title: 'Help', info: 'FAQs & Links'},
  ];
  ...
  imageGalleryLaunch = () => {
    ...
    launchImageLibrary(options, res => {
      ...
      if (res.didCancel) {
        ...
        // const simg=JSON.stringify(res);
        // console.log('response',simg );
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.img_div}>
        <Image source={{uri: `${selectimg}`}} style={styles.prof} />
        <TouchableOpacity
      ...
      <View style={styles.row2}>
        ...
        <Text style={styles.h3}>
          +91- {pdata?.phoneNumber} &bull; {pdata?.email}
        </Text>
      </View>
      ...
      <View style={styles.rr}>
        <View style={{flex: 1}}>
          <Text style={[styles.h4, {fontWeight: 'bold', fontSize: 17}]}>
            Adress
          </Text>
            ...
            <>
              <View style={styles.rr}>
                <View style={{flex: 1}}>
                  ...
                  <Text style={styles.h4}> {item.info} </Text>
                </View>
                <Image
                  source={require('../asets/images/profile/next.png')}
                  style={styles.arrow}
